...
/* date last modified: 2025-12-17 21:17:25 */
...
function main() {
            addJs('https://clustrmaps.com/bl/scripts/counter.js', "2210932");
...
function embed_clustrmaps(script_el, embed_after_script){
    ...
    if($('#clustrmaps-widget-v2').length === 0){
        ...
        */
                            var link = '<a target="_top" href="http://clustrmaps.com/site/1bdys" title="ClustrMaps People Search" id="clustrmaps-widget-v2">';
